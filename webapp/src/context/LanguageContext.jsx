...
export const LanguageProvider = ({ children }) => {
  ...
  const translations = {
    en: {
      ...
      nav: ['Buy', 'Sell', 'Rent', 'Mortgage', 'Agents', 'My Home', 'News'],
      hero: {
        title: 'Find a place to live...',
        tabs: ['Buy', 'Rent', 'Sell', 'Pre-approval', 'Just sold', 'Home value'],
    ...
    pt: {
      ...
      nav: ['Comprar', 'Vender', 'Alugar', 'Crédito', 'Agentes', 'Minha Casa', 'Notícias'],
      hero: {
        title: 'Encontre um lugar para morar...',
        tabs: ['Comprar', 'Alugar', 'Vender', 'Pré-aprovação', 'Vendidos', 'Valor da Casa'],
